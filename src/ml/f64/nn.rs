...
pub fn neural_network<'a>(parameters_: &'a [u16], learning_rate_: &'a f64) -> NeuralNetwork<'a>{
  NeuralNetwork{
...
pub fn neural_network_train(nn: &mut NeuralNetwork, input: &matrix::MatrixStruct, output: &matrix::MatrixStruct){
    {
